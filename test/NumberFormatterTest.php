...
use Mindy\Locale\Formatter\NumberFormatter;
...
class NumberFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->usFormatter = new NumberFormatter(new LocaleData('en_us'));
        $this->deFormatter = new NumberFormatter(new LocaleData('de'));
    }
